...
function paperRequirements(firstBookCopy, secondBookCopy, thirdBookCopy) {
    ...
    const secBookPageNeeded = 200;
    const thirdBookPageNeeded = 300;

    let firstBookQuantity = firstBookPageNeeded * firstBookCopy;
    let secondBookQuantity = secBookPageNeeded * secondBookCopy;
    let thirdbookQuantity = thirdBookPageNeeded * thirdBookCopy;

    const totalPageNeeded = firstBookQuantity + secondBookQuantity + thirdbookQuantity;
...
var result = paperRequirements(firstBookCopy, secondBookCopy, thirdBookCopy);
console.log(result);
...
let myFriendList = ['jomila', 'shakila', 'ariana grande ari', 'kabila', 'anna maria',];
